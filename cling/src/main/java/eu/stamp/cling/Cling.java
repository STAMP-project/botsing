...
import static eu.stamp.cling.CommandLineParameters.*;

import eu.stamp.cling.integrationtesting.IntegrationTesting;
...
public class Cling {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(Cling.class);
