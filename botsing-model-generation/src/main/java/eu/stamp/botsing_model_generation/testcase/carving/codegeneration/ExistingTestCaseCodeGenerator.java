...
public final class ExistingTestCaseCodeGenerator implements ICodeGenerator<TestCase> {

    private static final Logger logger = LoggerFactory.getLogger(org.evosuite.testcarver.testcase.EvoTestCaseCodeGenerator.class);
    //--- source generation
    private TestCase testCase;

    private final Map<Integer, VariableReference> oidToVarRefMap;

    public ExistingTestCaseCodeGenerator() {
