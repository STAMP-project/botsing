...
public class LineDistance extends TestFitnessFunction {
    ...
    public double getFitness(TestChromosome testChromosome, ExecutionResult executionResult) {
        ...
        double fitnessValue = fitnessCalculator.getLineCoverageFitness( executionResult, CrashProperties.getInstance().getStackTrace().getTargetLine());
