...
public class CrashProperties {
	...
	private void loadConfig() {
		try {
			InputStream inputstream = new FileInputStream(Paths.get(System.getProperty("user.dir"), "src", "main",
					"java", "eu", "stamp", "botsing", "config.properties").toString());
	...
	public static String getStringValue(String property)
			throws IllegalAccessException, Properties.NoSuchParameterException {
		if (Properties.hasParameter(property)) {
	...
	public static long getLongValue(String property)
			throws IllegalAccessException, Properties.NoSuchParameterException {
